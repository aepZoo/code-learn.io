...
export const webChapters: Chapter[] = [
  { id: 'html-basics', title: 'HTML — Les bases', description: 'Structure et balises essentielles', order: 1 },
  { id: 'html-forms', title: 'HTML — Formulaires', description: 'Inputs et boutons', order: 2 },
